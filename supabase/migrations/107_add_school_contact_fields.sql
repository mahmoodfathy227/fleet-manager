-- ====================================================
-- Add school contact fields to schools table
-- School phone number, email, contact person (for overview)
-- ====================================================
...
COMMENT ON COLUMN schools.contact_email IS 'Email address for the school / school contact';
